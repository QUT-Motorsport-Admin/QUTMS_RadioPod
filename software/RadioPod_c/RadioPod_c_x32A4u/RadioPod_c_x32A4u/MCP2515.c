...
{
	MCP2515_reg_write(MCP2515_RXM0EID0, 0b00000001);		//the mask will force RXB0 to only look at the last bits of the EID. looking for specific message types.
	MCP2515_reg_write(MCP2515_RXM1EID0, 0b00000001);
